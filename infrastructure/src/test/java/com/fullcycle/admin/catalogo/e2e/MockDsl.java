...
public interface MockDsl {
    ...
    default CategoryResponse retrieveACetegory(final Identifier id) throws Exception {
        return retrieve("/categories/", id, CategoryResponse.class);
    }

    default ResultActions updateACategory(final Identifier id, final UpdateCategoryRequest body) throws Exception {
    ...
    default ResultActions updateAGenre(final Identifier id, final UpdateGenreRequest body) throws Exception {
    ...
    private String given(final String url, final Object body) throws Exception {
        final var request = MockMvcRequestBuilders.post(url).contentType(MediaType.APPLICATION_JSON)
    ...
    private ResultActions list(final String url, final int page, final int perPage,
        ...
        final var aRequest =
                MockMvcRequestBuilders.get(url).queryParam("page", String.valueOf(page))
    ...
    private ResultActions update(final String url, final Identifier id, final Object body)
            throws Exception {
