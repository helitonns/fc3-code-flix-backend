...
public class ListCategoriesUseCaseIT {
    ...
    public void givenAValidTerm_whenTermDoesntMatchesPrePersisted_shouldReturnEmptyPage(){
        ...
        final var expectedTerms = "afasfasdfasf";
        final var expectedShort = "name";
        final var expectedDirection = "asc";
        final var expectedItemsCount = 0;
        final var expectedTotal = 0;

        final var aQuery = new SearchQuery(expectedPage, expectedPerPage, expectedTerms, expectedShort, expectedDirection);
    ...
    @CsvSource({
            ...
            //"name,asc,0,10,7,7,Sports",
            //"createdAt,desc,0,10,7,7,Series",
            //"createdAt,asc,0,10,7,7,Filmes"
    })
    public void givenAValidSortAndDirection_whenCallsCategories_shouldReturnCategoriesOrdered(
    ...
    public void givenAValidPage_whenCallsCategories_shouldReturnCategoriesPaginated(
            final int expectedPage,
            final int expectedPerPage,
            final int expectedItemsCount,
            final long expectedTotal,
