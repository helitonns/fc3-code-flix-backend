...
public class VideoTest extends UnitTest {
        ...
        public void givenValidVideo_whenCallsUpdateVideoMedia_shouldReturnUpdated() {
                ...
                final var aVideo = Video.newVideo(expectedTitle, expectedDescription,
                                expectedLaunchedAt, expectedDuration, expectedOpened,
                                expectedPublished, expectedRating, expectedCategories,
        ...
        public void givenValidVideo_whenCallsWith_shouldCreateWithoutEvents() {
                ...
                // when
                final var actualVideo = Video.with(VideoID.unique(), expectedTitle,
                                expectedDescription, expectedLaunchedAt, expectedDuration,
                                expectedOpened, expectedPublished, expectedRating,
                                InstantUtils.now(), InstantUtils.now(), null, null, null, null,
                                null, expectedCategories, expectedGenres, expectedMembers);
